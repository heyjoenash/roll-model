...
<SceneCue
  label="See it: Gentle 200 RPM roll"
  description="Watch how slowly a low-rev ball rotates — barely any spin visible"
  params={{ rpm: 200, showAxis: true }}
/>

<SceneCue
  label="See it: Aggressive 500 RPM hook"
  description="Now watch a cranker's rev rate — the ball rips through its rotation"
  params={{ rpm: 500, showAxis: true }}
/>
