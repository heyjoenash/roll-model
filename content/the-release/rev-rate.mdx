...
<SceneCue
  ...
  description="Watch how slowly a beginner's ball rotates — the ball barely turns. Check the RPM slider on the right."
  params={{ rpm: 150, showAxis: true, ballColor: "#22c55e" }}
/>

<SceneCue
  label="See it: Aggressive 600 RPM hook"
  description="Now watch elite two-handed rev rate — the ball becomes a blur. Watch the RPM slider jump."
  params={{ rpm: 600, showAxis: true, ballColor: "#ef4444" }}
/>
...
<SceneCue
  label="See it: Svensson's 600 RPM"
  description="Elite two-handed rev rate — the ball becomes a blur at this speed"
  params={{ rpm: 600, showAxis: true, ballColor: "#a855f7" }}
/>
...
<SceneCue
  label="See it: The sweet spot — 350 RPM tweener"
  description="A balanced rev rate that most recreational bowlers should aim for"
  params={{ rpm: 350, showAxis: false, ballColor: "#2563eb" }}
/>
